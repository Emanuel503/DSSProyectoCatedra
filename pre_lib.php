<h1>Prestamos de libros</h1><br>
<?php 
    if($_SESSION["id_rol"]==1){
        echo '<button data-bs-toggle="modal" data-bs-target="#modal" class="btn btn-primary">Prestar libro</button>';
      ...
      <div class="modal-body">
        <form action="#" method="POST">
          <div class="row g-3 align-items-center">
              ...
              <div class="col-2">
                  <label for="isbn" class="col-form-label">Ingrese la cantidad de dias: </label>
              </div>
              <div class="col-10">
                  <input type="number" class="form-control" name="dias_prestamo" max="20" min="1" required>
                  <spam>Maximo de dias 20</spam>
              </div>
            </div>  
      </div>  
