...
<table class="table table-active table-striped table-bordered">
    ...
    <tbody>
        <?php
            ...
            $multas = new Multas();
            $datos = $multas->mostrarMultas();
            
            $contador=0;
            foreach ($datos as $multa) {
                $contador++;
                echo "<tr>";
                    echo "<td>".$contador."</td>";
                    echo "<td>".$multa["multa"]."</td>";
                    echo "<td>$".$multa["costo"]."</td>";
                    echo "<td>".$multa["dias_maximos_multa"]."</td>";
                    echo "<td>".$multa["descripcion"]."</td>";
                    echo "<td>
                            <a href='page.php?pag=configuracion.php&opc=modificar_multas.php&id=".$multa["id"]."' class='btn btn-success'>Modificar</a>
                          </td>";
                echo "</tr>";
            }
        ?>
